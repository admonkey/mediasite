...
The code to create and populate the necessary tables is included in the 'secure_login.sql' file.  It populates the Users table with a single user with the following details:
