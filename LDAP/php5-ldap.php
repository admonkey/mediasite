...
?>
    <form id="ldap_login_form" role="form" method="POST">
      <div class="form-group">
        ...
        <input id="ldap_login_username" type="text" name="ldap_login_username" class="form-control"></input>
      </div>
      <div class="form-group">
        <label for="ldap_login_password">Password:</label>
        <input id="ldap_login_password" type="password" name="ldap_login_password" class="form-control"></input>
      </div>
